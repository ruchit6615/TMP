...
{
 $delete_sql="DELETE from booktable where Bid =' ".$_REQUEST['Bid_remove']."'";
 $del_result=mysqli_query($conn,$delete_sql);
 if($del_result)
 {
 	echo"<script> alert('record deleted');window.location='Manage_Booking.php';</script>";
 }
 else{
 	echo"<script> alert('record deleted failed !!');window.location='Manage_Booking.php';</script>";
 }
 }
?>
<!DOCTYPE html>
...
<thead>
        ...
        <th>Booking Date</th>
          ...
          <th>Remove</th>
                ...
                <td>
                <?php echo $row['Bsource']; ?>
                </td>
                <td>
                <?php echo $row['Bcharge']; ?>
                </td>
               <td align="center">
					        		<a href="Manage_Booking.php?Bid_remove=<?php echo $row ['Bid']?>"><img src  = "icons8-delete-16.png" width="30%" height="50%">
						</img></a>
						</td>
