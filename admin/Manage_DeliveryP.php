...
if(isset($_REQUEST['Did_remove']))
{
 $delete_sql="DELETE from deliveryperson where Did =' ".$_REQUEST['Did_remove']."'";
 $del_result=mysqli_query($conn,$delete_sql);
 if($del_result)
 {
 	echo"<script> alert('record deleted');window.location='Manage_DeliveryP.php';</script>";
 }
 else{
 	echo"<script> alert('record deleted failed !!');window.location='Manage_DeliveryP.php';</script>";
 }
 }
?>
				...
				<div class="page-inner">
					<div class="page-header">
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#"><i class="fa fa-male"></i> Manage DeliveryPerson</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"><i class="fa fa-male"></i> Manage DeliveryPerson </div>
								</div>
								<div class="card-body">
...
<tr bgcolor=#E1C16E>
        ...
        <th>DeliveryPerson name</th>
          <th>DeliveryPerson contact</th>
          <th>DeliveryPerson email</th>
          <th>Remove</th>
                ...
                <td align="center">
					        		<a href="Manage_DeliveryP.php?Did_remove=<?php echo $row ['Did']?>"><img src  = "icons8-delete-16.png" width="30%" height="50%">
						</img></a>
						</td>
