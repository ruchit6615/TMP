...
{
 $delete_sql="DELETE from usertable where Uid =' ".$_REQUEST['Uid_remove']."'";
 $del_result=mysqli_query($conn,$delete_sql);
 if($del_result)
 {
 	echo"<script> alert('record deleted');window.location='Manage_user.php';</script>";
 }
 else{
 	echo"<script> alert('record deleted failed !!');window.location='Manage_user.php';</script>";
 }
 }
?>
<!DOCTYPE html>
						...
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title"><i class="fa fa-users"></i> Manage Users </div>
								</div>
								<div class="card-body">
...
<tr bgcolor=#E1C16E>
        ...
        <th>User Name</th>
          ...
          <th>Remove</th>
               ...
               <td align="center">
					        		<a href="Manage_user.php?Uid_remove=<?php echo $row ['Uid']?>"><img src  = "icons8-delete-16.png" width="30%" height="50%">
						</img></a>
						</td>
